...
{
  $("[name=MCI-1] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-1]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-1]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-1]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-1]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-2] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-2]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-2]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-2]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-2]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-3] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-3]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-3]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-3]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-3]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-4] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-4]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-4]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-4]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-4]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-5] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-5]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-5]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-5]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-5]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-6] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-6]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-6]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-6]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-6]').attr('src', "image/Circulo.png");
    }
  });
  $("[name=MCI-7] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-7]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-7]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-7]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-7]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-8] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-8]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-8]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-8]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-8]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-9] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-9]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-9]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-9]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-9]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-10] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-10]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-10]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-10]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-10]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-11] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-11]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-11]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-11]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-11]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-12] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-12]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-12]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-12]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-12]').attr('src', "image/Circulo.png");
    }
  });
  $("[name=MCI-13] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-13]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-13]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-13]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-13]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-14] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-14]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-14]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-14]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-14]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-15] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-15]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-15]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-15]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-15]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-16] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-16]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-16]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-16]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-16]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-17] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-17]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-17]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-17]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-17]').attr('src', "image/Circulo.png");
    }
  });

  $("[name=MCI-18] a").on('click', function(e) {
    e.preventDefault(); // cancel the link behaviour
    var selText = $(this).text();
    if (selText == 'Cumpriu'){
      $('[name=imgMCI-18]').attr('src', "image/Feito.png");
    } else if(selText == 'Não cumpriu'){
      $('[name=imgMCI-18]').attr('src', "image/Nao_feito.png");
    } else if(selText == 'Em andamento'){
      $('[name=imgMCI-18]').attr('src', "image/Andamento.png");
    } else if(selText == 'Próximos'){
      $('[name=imgMCI-18]').attr('src', "image/Circulo.png");
    }
  });
